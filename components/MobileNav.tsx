      ...
      {isOpen && (
        <>
          ...
          >
             ...
             <div className="p-4 border-t border-slate-200 dark:border-slate-800 text-[10px] text-slate-500 dark:text-slate-600 text-center transition-colors duration-300">
                © 2024 AI Mastery Hub
             </div>
          </motion.div>
        </>

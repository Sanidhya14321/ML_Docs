...
export const MathBlock: React.FC<MathBlockProps> = ({ children, label, type = 'block' }) => {
  ...
  return (
    <motion.div 
      ...
      className="my-10 p-8 bg-slate-900/30 border-2 border-slate-800/50 rounded-3xl relative group overflow-hidden"
    >
      ...
      <div className="math-serif text-2xl md:text-3xl text-slate-100 leading-relaxed tracking-wider text-center py-4 font-light">
        {children}
      </div>

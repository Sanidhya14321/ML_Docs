    ...
    <div className={`mx-auto ${isCompact ? 'max-w-none px-2' : 'max-w-4xl pb-24'}`}>
      ...
      <div className={`prose prose-invert ${isCompact ? 'prose-sm max-w-none' : 'prose-lg max-w-none'}`}>
         ...
         {!isCompact && showStartLab && (
             <div className="mt-16 p-1 rounded-2xl bg-gradient-to-r from-indigo-500 via-purple-500 to-pink-500">
                <div className="bg-slate-950 rounded-xl p-8 text-center">
                    ...
                    <p className="text-slate-400 mb-6">Launch the interactive workspace to apply these concepts against real data.</p>
                    <a href={`#lab/${topicId}`} className="px-6 py-3 bg-white text-slate-950 font-bold rounded-lg hover:bg-slate-200 transition-colors flex items-center gap-2 mx-auto w-fit shadow-xl">
